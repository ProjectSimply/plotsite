...
<section class="plotLayout imageTiles <?= get_sub_field('plotcms_color_scheme') == 'alternative' ? 'altColourScheme' : "" ?>">
                ...
                <?php for($column = 1; $column <= 2; $column++) : ?>
                    ...
                    <div class="imageTiles__gridItem imageTiles__gridItem--<?= $i; ?>">
                        ...
                        <a class="JS--plotModalButton plotHasHoverEffect" href="#" 
                            ...
                            data-plot-modal-contents="<?= $randomID ?>--<?= $i . $column ?>" data-plot-modal-group="<?= $randomID ?>">
