<section class="fiftyFifty plotLayout fiftyFifty--<?= get_sub_field('layout_option') ?> <?= get_sub_field('plotcms_color_scheme') == 'alternative' ? 'altColourScheme' : "" ?>">
    ...
    <div class="maxWidth">
        ...
        <div class="fiftyFifty__row">
            ...
            <div class="fiftyFifty__textWrap">
            	...
            	<div class="fiftyFifty__textWrapInner">
