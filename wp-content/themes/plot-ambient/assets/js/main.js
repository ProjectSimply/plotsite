...
(function () {
  ...
  PossibleDropdowns = {
    ...
    createListeners: function createListeners() {
      var selectors = document.querySelectorAll('.plotPossibleDropdown__selector');
      if (selectors.length > 0) document.addEventListener('click', function (event) {
      ...
      window.addEventListener('resize', PossibleDropdowns.detect, {
        passive: true
      });
      PossibleDropdowns.detect();
    },
    closeAll: function closeAll() {
      var possibleDropdowns = document.querySelectorAll('.plotPossibleDropdown--open');
      ...
      if (possibleDropdowns.length > 0) {
        ...
        try {
          for (var _iterator = possibleDropdowns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var possibleDropdown = _step.value;
    ...
    switchActiveLink: function switchActiveLink(target) {
      var content = target.closest('.plotPossibleDropdown__item').innerHTML;
      var nearestSelector = target.closest('.plotPossibleDropdown').querySelector('.plotPossibleDropdown__selector');
      var nearestItems = target.closest('.plotPossibleDropdown').querySelectorAll('.plotPossibleDropdown__item');
      ...
      if (nearestItems.length > 0) {
        ...
        try {
          for (var _iterator2 = nearestItems[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    openOrClose: function openOrClose(target) {
      var possibleDropdown = target.closest('.plotPossibleDropdown');
      if (possibleDropdown.classList.contains('plotPossibleDropdown--open')) possibleDropdown.classList.remove('plotPossibleDropdown--open');else {
        var possibleDropdowns = document.querySelectorAll('.plotPossibleDropdown--open');
        ...
        if (possibleDropdowns.length > 0) {
          ...
          try {
            for (var _iterator3 = possibleDropdowns[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var pD = _step3.value;
    ...
    detect: function detect() {
      var possibleDropdowns = document.querySelectorAll('.plotPossibleDropdown');
      var _iteratorNormalCompletion4 = true;
      var _didIteratorError4 = false;
      var _iteratorError4 = undefined;

      try {
        for (var _iterator4 = possibleDropdowns[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var possibleDropdown = _step4.value;
          var buttons = possibleDropdown.querySelectorAll('.plotPossibleDropdownVisibleItems');
          var selector = possibleDropdown.querySelector('.plotPossibleDropdown__selector');
          var buttonsWidth = 0;
          ...
          if (buttons.length > 0) {
            ...
            try {
              for (var _iterator5 = buttons[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
(function () {
  ...
  TextLineup = {
    init: function init() {
      ...
      window.addEventListener('resize', TextLineup.removeUnneccesarySeparators, {
        passive: true
      });
    },
    removeUnneccesarySeparators: function removeUnneccesarySeparators() {
      var textLineups = document.querySelectorAll('.textLineup__tier');
      var resetElements = document.querySelectorAll('.textLineup__separator, .textLineup__artist--hiddenSeparator');
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = resetElements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var resetElement = _step.value;
      ...
      try {
        for (var _iterator2 = textLineups[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var textLineup = _step2.value;
          var artists = document.querySelectorAll('.textLineup__artist');
          var lastArtist;
          var _iteratorNormalCompletion3 = true;
          var _didIteratorError3 = false;
          var _iteratorError3 = undefined;
          ...
          try {
            for (var _iterator3 = artists[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var artist = _step3.value;

              if (lastArtist) {
                var artistStyle = getComputedStyle(lastArtist);
                var lineHeight = parseInt(artistStyle.getPropertyValue('line-height'));
...
(function () {
  ...
  Main = {
    ...
    init: function init() {
      ...
      window.addEventListener('resize', Main.detectIfMobileMenuNeeded, {
        passive: true
      });
      Main.seeIfBannerShouldBeShuntedDown();
      window.addEventListener('resize', Main.seeIfBannerShouldBeShuntedDown, {
        passive: true
      });
    ...
    dropdownMenus: function dropdownMenus() {
      ...
      try {
        for (var _iterator = dropdownMenuItems[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var dropdownMenuItem = _step.value;
      ...
      try {
        for (var _iterator2 = burgerDropdownMenuItems[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var burgerDropdownMenuItem = _step2.value;
          burgerDropdownMenuItem.addEventListener('click', function (event) {
            if (!event.target.closest('a')) if (this.classList.contains('subnavigationOpen')) this.classList.remove('subnavigationOpen');else this.classList.add('subnavigationOpen');
          });
        }
      } catch (err) {
        _didIteratorError2 = true;
    ...
    adjustSpacingForLayouts: function adjustSpacingForLayouts() {
      var layouts = document.querySelectorAll('.plotLayout');
      var banner = document.querySelector('.banner');
      var previousBackground = 'normal';
      var wasPreviousFullScreenImage = false;
      var i = 0;
      var _iteratorNormalCompletion3 = true;
      var _didIteratorError3 = false;
      var _iteratorError3 = undefined;
      ...
      try {
        for (var _iterator3 = layouts[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var layout = _step3.value;
          if (previousBackground == 'normal') layout.classList.add('lastLayoutWasNormal');else layout.classList.add('lastLayoutWasAlternativeColor');
          ...
          i++;
          if (i == layouts.length) layout.classList.add('lastLayout');
          if (i == 1 && !banner.classList.contains('textOnlyBanner')) layout.classList.add('firstLayout');
        }
      } catch (err) {
        _didIteratorError3 = true;
        _iteratorError3 = err;
    ...
    seeIfBannerShouldBeShuntedDown: function seeIfBannerShouldBeShuntedDown() {
      if (Main.bannerElement) {
        if (document.body.dataset.plotSolidHeader == 'true' || Main.bannerElement.classList.contains('textOnlyBanner') || Main.bannerElement.classList.contains('maxWidth')) {
          Main.bannerElement.style.paddingTop = "".concat(document.querySelector('#siteMainHeader').clientHeight, "px");
        } else {
    ...
    detectIfMobileMenuNeeded: function detectIfMobileMenuNeeded() {
      if (document.body.dataset.plotCustomizerNavigationType == "mobileBurger") {
        var headerElements;
        var navigationAlignment = document.body.dataset.plotCustomizerNavigationAlignment;
        var headerWrap = document.querySelector('.siteMainHeader__wrap');

        if (headerWrap) {
          if (navigationAlignment == 'left') headerElements = document.querySelectorAll('.siteMainHeader__wrap>*');else headerElements = document.querySelectorAll('.siteMainHeader__desktop-menu li');
          var totalWidth = 0;
          var _iteratorNormalCompletion4 = true;
          var _didIteratorError4 = false;
          var _iteratorError4 = undefined;
          ...
          try {
            for (var _iterator4 = headerElements[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
},{"../../../plot-core/src/js/carousels":26,"../../../plot-core/src/js/lazyload":27,"../../../plot-core/src/js/modals":28,"../../../plot-core/src/js/plot":29,"./features/possible-dropdowns":1,"./features/text-lineup":2,"./pages/artists":4,"./pages/home":5,"./pages/news":6,"./pages/schedule":7}],4:[function(require,module,exports){
"use strict";
...
(function () {
  ...
  Artists = {
    ...
    checkForURLParamsAndPopulateFilters: function checkForURLParamsAndPopulateFilters() {
      //Do we have any URL Params
      var urlParams = new URLSearchParams(window.location.search); //gather them

      Artists.filterData.artistType = urlParams.get('artist-type');
      Artists.filterData.artistDay = urlParams.get('artist-day');
      if (Artists.filterData.artistType) var elementWithArtistType = document.querySelector('[data-artist-type-id="' + Artists.filterData.artistType + '"]');else var elementWithArtistType = document.querySelector('[data-artist-type-id="all"]');
      if (elementWithArtistType) Artists.processDropdowns(elementWithArtistType, 'artist');
      if (Artists.filterData.artistDay) var elementWithDay = document.querySelector('[data-artist-date="' + Artists.filterData.artistDay + '"]');else var elementWithDay = document.querySelector('[data-artist-date="all"]');
      if (elementWithDay) Artists.processDropdowns(elementWithDay, 'date');
    },
    checkFiltersOnPopstate: function checkFiltersOnPopstate(e) {
      ...
      Artists.loadArtists(false).then(function () {
        var artistsMain = document.querySelector('.artistsMain');
    ...
    createListeners: function createListeners() {
      if (Artists.loadMoreButton) Artists.loadMoreButton.addEventListener('click', function (e) {
      ...
      document.addEventListener('click', function (e) {
        ...
        if (e.target.closest('.JS--artistDayButton')) {
          ...
          document.querySelectorAll('.JS--artistDayButton').forEach(function (artistDayButton) {
        ...
        if (e.target.closest('.artistFiltersButton')) {
          var filters = document.querySelector('.artistFilters');
          if (filters) if (filters.classList.contains('artistFilters--open')) filters.classList.remove('artistFilters--open');else filters.classList.add('artistFilters--open');
        }
      }, false);
    },
    processDropdowns: function processDropdowns(target, type) {
      var items = Artists.dropdownItemForArtistDays;
      var selector = Artists.dayFilterDropdownSelector;
      var dataType = 'artistDate';
      var currentFilter = Artists.filterData.artistDay;
      ...
      if (selector) selector.innerHTML = target.innerHTML;
    },
    loadArtistType: function loadArtistType(target) {
      ...
      var buttonsToBeSelected = document.querySelectorAll('[data-artist-type-id="' + Artists.filterData.artistType + '"]');
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = buttonsToBeSelected[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    buildQueryString: function buildQueryString() {
      var queryString = "?";
      if (Artists.filterData.pge != 1) queryString += 'pge=' + Artists.filterData.pge + '&';
      if (Artists.filterData.artistType != false && Artists.filterData.artistType != null) queryString += 'artist-type=' + Artists.filterData.artistType + '&';
      if (Artists.filterData.artistDay != false && Artists.filterData.artistDay != null) queryString += 'artist-day=' + Artists.filterData.artistDay + '&';
    ...
    showOrHideLoadMoreButton: function showOrHideLoadMoreButton() {
      ...
      if (maxPageElem) {
        ...
        if (Artists.maxPages > Artists.filterData.pge) Artists.loadMoreButton.classList.remove('hidden');else Artists.loadMoreButton.classList.add('hidden');
      }
    }
  };
...
},{"../../../../plot-core/src/js/modals":28,"../../../../plot-core/src/js/plot":29}],5:[function(require,module,exports){
"use strict";
...
},{"../../../../plot-core/src/js/plot":29}],7:[function(require,module,exports){
"use strict";
...
(function () {
  ...
  Schedule = {
    ...
    checkIfWeNeedATallerSchedule: function checkIfWeNeedATallerSchedule() {
      Schedule.schedule.classList.add('loaded');
      var calendarHeight = Schedule.currentCalendar.getBoundingClientRect().height;
      var performances = Schedule.currentCalendar.querySelectorAll('.scheduleCalendar__performanceInner');
      ...
      try {
        for (var _iterator3 = performances[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var performance = _step3.value;
    ...
    loadNewDate: function loadNewDate(elem) {
      ...
      try {
        for (var _iterator4 = Schedule.dayButtons[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var dB = _step4.value;
    ...
    checkToSeeIfNavArrowsNeeded: function checkToSeeIfNavArrowsNeeded() {
      var tracks = Schedule.currentCalendar.querySelector('.scheduleCalendarTracks');
...
},{"desandro-matches-selector":9}],12:[function(require,module,exports){
// add, remove cell
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":16,"fizzy-ui-utils":11}],13:[function(require,module,exports){
// animate
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"fizzy-ui-utils":11}],14:[function(require,module,exports){
// Flickity.Cell
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":16,"fizzy-ui-utils":11,"unidragger":24}],16:[function(require,module,exports){
// Flickity main
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./animate":13,"./cell":14,"./slide":22,"ev-emitter":10,"fizzy-ui-utils":11,"get-size":23}],17:[function(require,module,exports){
/*!
 * Flickity v2.2.1
...
},{"./flickity":16,"fizzy-ui-utils":11}],19:[function(require,module,exports){
// page dots
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":16,"fizzy-ui-utils":11,"unipointer":25}],20:[function(require,module,exports){
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":16,"ev-emitter":10,"fizzy-ui-utils":11}],21:[function(require,module,exports){
// prev/next buttons
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":16,"fizzy-ui-utils":11,"unipointer":25}],22:[function(require,module,exports){
// slide
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"ev-emitter":10}],26:[function(require,module,exports){
"use strict";
...
},{"./lazyload":27,"flickity":17}],27:[function(require,module,exports){
"use strict";
...
},{"./lazyload":27,"./plot":29,"body-scroll-lock":8}],29:[function(require,module,exports){
"use strict";
...
},{"./lazyload":27,"./syncscroll":30,"body-scroll-lock":8}],30:[function(require,module,exports){
"use strict";
