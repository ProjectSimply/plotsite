jQuery( document ).ready(function($) {
	...
	var customFonts = $('#customize-control-primaryFontRegular, #customize-control-primaryFontItalic, #customize-control-primaryFontBold, #customize-control-primaryFontBoldItalic, #customize-control-headingFont')
	var googleFonts = $('.google_fonts_select_control')

	$('#customize-control-plotFontType input').on('change',function(){

		hideOrShowFontOptions($(this).val())

	})

	hideOrShowFontOptions($('#customize-control-plotFontType input[checked]').val())

	function hideOrShowFontOptions(option) {
		...
		if(option == 'custom') {
			...
			customFonts.hide()
			googleFonts.show()
			var elem =$('.google-fonts-list').parent().parent();
			elem.find('.customize-control-google-font-selection').val(JSON.stringify([])).trigger('change');
			skyrocketGetAllSelects($('.google-fonts-list').parent().parent())
		}
	}
