  ...
  Home = {
    ...
    startThemeCounter: function startThemeCounter() {
      ...
      Home.counter = setInterval(function () {
        ...
        Home.body.dataset.previousTheme = Home.previousTheme; // Update state
