...
(function () {
  ...
  Home = {
    ...
    createListeners: function createListeners() {
      ...
      Home.dom.body.addEventListener('mousemove', function (e) {
    ...
    runMouseMove: function runMouseMove() {
      ...
      Home.dom.phone.style.transform = "rotate3d(".concat(.6 * yShift + .4, ",").concat(xShift, ",0,10deg) translate3d(").concat(xShift * 20, "px,").concat(yShift * 20, "px,0)");
