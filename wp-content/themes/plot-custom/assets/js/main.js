  ...
  Home = {
    ...
    startThemeCounter: function startThemeCounter() {
      ...
      Home.counter = setInterval(function () {
        ...
        if (Home.previousTheme) Home.body.classList.remove(Home.previousTheme); // Change the class on the body element

        document.body.classList.add("homeBannerTheme--".concat(Home.themes[i])); // Update state

        Home.previousTheme = "homeBannerTheme--".concat(Home.themes[i]); // If we reach the end of the themes, reset to first theme
    ...
    removeTheme: function removeTheme() {
      if (Home.previousTheme) Home.body.classList.remove(Home.previousTheme);
      Home.previousTheme = '';
    },
