...
(function () {
  ...
  Home = {
    ...
    init: function init() {
      Home.createListeners(); // Home.startThemeCounter()
    ...
    runMouseMove: function runMouseMove() {
      ...
      var yShift = (Home.previousMousePosition.Y - window.innerHeight / 2) / (window.innerHeight / 2);
      Home.phone.style.setProperty('--xShift', xShift);
      Home.phone.style.setProperty('--yShift', yShift);
      if (differenceOfPositions.X + differenceOfPositions.Y < .1) Home.ticker = false;
