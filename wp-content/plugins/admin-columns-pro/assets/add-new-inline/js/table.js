...
var _screenOption = _interopRequireDefault(__webpack_require__(/*! ./screen-option */ "./add-new-inline/js/modules/screen-option.js"));

var _createButton = _interopRequireDefault(__webpack_require__(/*! ./create-button */ "./add-new-inline/js/modules/create-button.js"));
...
function () {
  function AddNewInline() {
    ...
    this.loading = false;
    this.createButton = new _createButton["default"]();
    ...
    if (screenOptionsElement) {
      this.screenOption = new _screenOption["default"](screenOptionsElement);
    }
...
function () {
  ...
  _createClass(CreateButton, [{
    ...
    value: function createElement() {
      ...
      element.classList.add('ac-button', 'ac-add-new-inline', 'add-new-h2');
...
var _addNewInline = _interopRequireDefault(__webpack_require__(/*! ./modules/add-new-inline */ "./add-new-inline/js/modules/add-new-inline.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

jQuery(function () {
  AdminColumns.AddNewInline = new _addNewInline["default"]();
});
